...
pluck(quadsoa_meta_loo$influence) %>% pluck(12) %>%
forest.meta(., 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(10) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(11) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(4) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(8) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(6) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(7) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
...
pluck(quadsoa_meta_loo$influence) %>% pluck(5) %>%
forest.meta(., 
            lower.equi = exp(last(.$lower)), 
            upper.equi = exp(last(.$upper)), 
            col.equi = "green", 
